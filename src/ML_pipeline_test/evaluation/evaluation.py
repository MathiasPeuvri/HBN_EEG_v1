...
def run_comprehensive_evaluation(
    ...
    if output_dir is None:
        output_dir = Path("/home/mts/HBN_EEG_Analysis/src/ML_pipeline_test/saved_models")
        if not output_dir.exists():
            output_dir.mkdir(parents=True, exist_ok=True)
    
    if dataset_dir is None:
        dataset_dir = Path("/home/mts/HBN_EEG_Analysis/datasets/evaluation_datasets")
    
    # Set participants.tsv path for R2_mini_L100_bdf evaluation database
    participants_tsv_path = Path("/home/mts/HBN_EEG_Analysis/database/R2_mini_L100_bdf/participants.tsv")

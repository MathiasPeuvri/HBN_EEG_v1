...
for i, SUBJECT in enumerate(SUBJECTS):
    ...
    if (i + 1) % nb_suj_per_shard == 0:
        ...
        with open(PROJECT_ROOT / "datasets" / f'pretraining_data_shard_{shard_subjects_counter}.pkl', 'wb') as f:
...
# save the data
#========================================================
with open(PROJECT_ROOT / "datasets" / 'pretraining_data.pkl', 'wb') as f:
        pickle.dump(pretraining_data, f)

with open(PROJECT_ROOT / "datasets" / 'posttraining_data.pkl', 'wb') as f:
    pickle.dump(posttraining_data, f)

# Save corrected data
with open(PROJECT_ROOT / "datasets" / 'challenge_1_data.pkl', 'wb') as f:
